...
- **Shot A (0:50–0:55):** Terminal, clean and calm (return to the warm palette terminal theme, not the cold one from the problem montage). Type: `npx arniejs-cli add bloom-button`. Enter.
...
- **Visual:** Terminal, `npx arniejs-cli add bloom-button`, files appear, cut to it working in browser.
- **Text overlay:** "npx arniejs-cli add [anything]"
